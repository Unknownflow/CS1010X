...
#print("corret for this case:", prefix_infix(['+', '*', 5, 4, '-', 2, 1]))
...
##
##print(accumulate(lambda x,y: y+[x], [], map(lambda x: x*2, filter(lambda x: x%3!=0, enumerate_interval(1, 10)))))
...
def power_set(a):
    if a==[]:
        ...
        #print("r1: ", result1)
        result2 = list(map(lambda x: x + [a[0]], result1))  # need the "list", else object
